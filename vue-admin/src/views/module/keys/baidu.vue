<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column prop="apikey" label="API Key" width="260" />
      <el-table-column prop="secretkey" label="Secret Key" width="260" />
      ...
      >
        <el-form ref="form" :model="form" :rules="formRules" label-width="100px">
          <el-form-item label="ApiKey" prop="apikey">
            <el-input v-model="form.apikey" placeholder="填入百度文心应用的API Key" size="small" style="width: 300px;" />
          </el-form-item>
          <el-form-item label="SecretKey" prop="secretkey">
            <el-input v-model="form.secretkey" placeholder="填入百度文心应用的Secret Key" size="small" style="width: 300px;" />
          </el-form-item>
          <el-form-item label="备注" prop="remark">
            ...
            />
            <p style="line-height: 26px; margin: 5px 0 0 0;">内测阶段，<a class="text-primary" href="https://console.ttk.ink/api.php/link/ai/name/baidu" target="_blank">直达链接</a></p>
          </el-form-item>
        </el-form>
    ...
    doSubmit(formName) {
      this.$refs.form.validate((valid) => {
        if (valid) {
          ...
          this.form.key = this.form.apikey + '|' + this.form.secretkey
