<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column prop="key" label="Token" width="260" />
    ...
    <div v-if="form">
      ...
      >
        <el-form ref="form" :model="form" :rules="formRules" label-width="100px">
          <el-form-item label="Token" prop="key">
            <el-input v-model="form.key" placeholder="Repliate的token" size="small" style="width: 300px;" />
            <p><a class="text-primary" href="https://replicate.com/account/api-tokens" target="_blank">Token获取地址</a></p>
          </el-form-item>
