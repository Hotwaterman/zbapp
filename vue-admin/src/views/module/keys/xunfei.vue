      ...
      >
        <el-form ref="form" :model="form" :rules="formRules" label-width="100px">
          <el-form-item label="APPID" prop="appid">
            <el-input v-model="form.appid" placeholder="填入讯飞星火的APPID" size="small" style="width: 300px;" />
          </el-form-item>
          <el-form-item label="APISecret" prop="apisecret">
            <el-input v-model="form.apisecret" placeholder="填入讯飞星火的API Secret" size="small" style="width: 300px;" />
          </el-form-item>
          <el-form-item label="APIKey" prop="apikey">
            <el-input v-model="form.apikey" placeholder="填入讯飞星火的API Key" size="small" style="width: 300px;" />
          </el-form-item>
          <el-form-item label="备注" prop="remark">
            ...
            />
            <p style="line-height: 26px; margin: 5px 0 0 0;">内测阶段，<a class="text-primary" href="https://console.ttk.ink/api.php/link/ai/name/xunfei" target="_blank">直达链接</a></p>
          </el-form-item>
        </el-form>
    ...
    doSubmit(formName) {
      this.$refs.form.validate((valid) => {
        if (valid) {
          ...
          this.form.key = this.form.appid + '|' + this.form.apisecret + '|' + this.form.apikey
