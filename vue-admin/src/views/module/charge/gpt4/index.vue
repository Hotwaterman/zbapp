<template>
  <div class="app-container">
    <div class="toolbar">
      <el-button type="primary" icon="el-icon-plus" size="mini" @click="showForm(0)">新增GPT4套餐</el-button>
    </div>
    <el-table
      :data="dataList"
      stripe
    ...
    />
    <edit v-if="gpt4" :gpt4="gpt4" @close="closeForm" @submit="saveInfo" />
  </div>
</template>

<script>
import { getList, getInfo, saveInfo, del, setStatus, setDefault } from '@/api/gpt4'
