<template>
  <div class="app-container">
    <div class="toolbar">
      <el-button type="primary" icon="el-icon-plus" size="mini" @click="showForm(0)">新增vip套餐</el-button>
    </div>
    <el-table
      :data="dataList"
      stripe
    ...
    >
      ...
      <el-table-column prop="num" label="时长" width="100">
    ...
    />
    <edit v-if="vip" :vip="vip" @close="closeForm" @submit="saveInfo" />
  </div>
</template>

<script>
import { getList, getInfo, saveInfo, del, setStatus, setDefault } from '@/api/vip'
