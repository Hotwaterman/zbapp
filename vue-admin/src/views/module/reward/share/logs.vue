<template>
  <div class="app-container" style="padding: 0;">
    ...
    <div class="box-panel" style="padding-bottom: 10px; margin-bottom: 0;">
      ...
      >
        <el-table-column prop="id" label="分享ID" width="80" />
        <el-table-column prop="create_time" label="分享时间" width="160" />
        <el-table-column prop="user_id" label="用户ID" width="100" />
        <el-table-column prop="way" label="分享类型" width="150">
        ...
        <el-table-column prop="invite_num" label="邀请到" width="100">
          <template slot-scope="scope">
            <span>{{ scope.row.invite_num }} 人</span>
          </template>
        </el-table-column>
        <el-table-column prop="reward_num" label="分享奖励">
          <template slot-scope="scope">
...
<script>
import { getShareList, getShareTongji } from '@/api/reward'
