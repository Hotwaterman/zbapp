<template>
  <div class="app-container" style="padding-bottom: 30px;">
    <div class="toolbar">
      <el-button type="primary" icon="el-icon-plus" size="mini" @click="clickAdd">添加知识库</el-button>
    </div>
    <el-table
      :data="dataList"
      stripe
    ...
    >
      <el-table-column prop="weight" label="排序" width="60" />
      <el-table-column prop="title" label="知识库名称" width="300" />
      ...
      >
        <el-form ref="form" :model="form" :rules="formRules" label-width="120px">
          ...
          <el-form-item label="知识库名称" prop="title">
            <el-input v-model="form.title" placeholder="知识库名称" size="small" style="width: 200px;" />
          </el-form-item>
        </el-form>
...
<script>
import { getBookList, saveBook, getBook, delBook, setBookState } from '@/api/book'
...
export default {
  ...
  computed: {
    formTitle() {
      return this.formType === 'add' ? '添加知识库' : '编辑'
    }
  },
  mounted() {
    this.getList()
