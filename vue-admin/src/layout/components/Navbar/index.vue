<template>
  <div class="navbar">
    ...
    <div class="right-menu">
      ...
      <Zhanzhang v-if="host.indexOf('ai.ttk.ink') !== -1" />
<!--      <kuangtuan v-if="host.indexOf('work.ttk.ink') !== -1" />-->
      <Contact v-if="host.indexOf('.ttk.ink') !== -1" />
...
import Zhanzhang from '@/components/Zhanzhang'
import Kuangtuan from '@/components/Kuangtuan'

export default {
  components: { Logo, Contact, Zhanzhang, Kuangtuan },
  data() {
